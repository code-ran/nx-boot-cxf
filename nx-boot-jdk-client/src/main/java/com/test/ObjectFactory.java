...
public class ObjectFactory {
    ...
    private final static QName _SayHello_QNAME = new QName("http://impl.service.shzx.com/", "sayHello");
    private final static QName _GetInfoResponse_QNAME = new QName("http://impl.service.shzx.com/", "getInfoResponse");
    private final static QName _GetInfo_QNAME = new QName("http://impl.service.shzx.com/", "getInfo");
    private final static QName _SayHelloResponse_QNAME = new QName("http://impl.service.shzx.com/", "sayHelloResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.shzx.com/", name = "sayHello")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.shzx.com/", name = "getInfoResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.shzx.com/", name = "getInfo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.shzx.com/", name = "sayHelloResponse")
